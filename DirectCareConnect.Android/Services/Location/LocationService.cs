...
using DirectCareConnect.Droid.Transformation.Extensions;
...
namespace DirectCareConnect.Droid.Services.Location
{
    ...
    public class LocationService : Service, ILocationListener
    {
        ...
        const string NOTIFICATION_CHANNEL_ID = "com.directcareconnect.app.channel";
        ...
        async public void OnLocationChanged(Android.Locations.Location location)
        {
            ...
            await LocationChangeHandler.GetLocationChangeHandler(Xamarin.Forms.DependencyService.Get<IJobService>(), Xamarin.Forms.DependencyService.Get<ILoggingService>()).UpdateLocation(location.ToCurrentLocation());
            /*
        ...
        public override StartCommandResult OnStartCommand(Intent intent, StartCommandFlags flags, int startId)
        {
            ...
            {
                Log.Debug(logTag, "Foreground starting");
                ...
                Log.Debug(logTag, "Foreground started");
            }
