...
namespace DirectCareConnect.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddBlazorMobileNativeServices<DirectCareConnect.Blazor.Program>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //DirectCareConnect.Blazor.Startup.Services = app.ApplicationServices;
