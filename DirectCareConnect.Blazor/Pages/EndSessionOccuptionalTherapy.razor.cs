...
{
    public class EndSessionOccuptionalTherapyBase : EndSessionBase
    {
        public EndSessionOccupationalTherapyModel Model
        {
            get
            {
                return this.model as EndSessionOccupationalTherapyModel;
            }
        ...
        public EndSessionOccuptionalTherapyBase()
        {
            this.Model = new EndSessionOccupationalTherapyModel();
        }
        ...
        async protected override Task OnInitializedAsync()
        {
            try
            {
                this.Model = await this.JobService.GetEndSessionOccuptionalTherapyModel(this.RestToken, this.ClientId, this.ClientServiceId, this.RemoteDocumentId, this.InternalDocId);
